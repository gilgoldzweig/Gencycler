package com.goldzweigapps.plugin
...
/**
 * Created by gilgoldzweig on 25/02/2018.
 */
class GencyclerPlugin: Plugin<Project> {
    override fun apply(project: Project) {
        project.plugins.all {
            when (it) {
                ...
                is LibraryPlugin -> project.extensions[LibraryExtension::class].run {
                    configureR2Generation(project, libraryVariants)
                }
                is AppPlugin -> {
